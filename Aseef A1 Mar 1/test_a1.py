...
EVENT_FILE_5 = '''10 Arrive Tamara Bananas 7
5 Arrive Jugo Bread 3 Cheese 3
'''


def test_simulation_5() -> None:
    """Test two events and single checkout simulation."""
    gss = GroceryStoreSimulation(StringIO(CONFIG_FILE_5))
    gss.run(create_event_list(StringIO(EVENT_FILE_5)))
    assert gss.stats == {'num_customers': 2, 'total_time': 18, 'max_wait': 8}
